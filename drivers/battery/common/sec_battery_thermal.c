...
=======
	...
	/* exception handling */
	if (!is_hv_wireless_type(ct) || battery->pdata->wpc_thm_info.check_type == SEC_BATTERY_TEMP_CHECK_NONE) {
>>>>>>> upstream/android-13
...
=======
	pr_info("%s: vout_level: %d, chg_limit: %d, wpc_temp(%d), trc(%d/%d/%d)\n", __func__,
			battery->wpc_vout_level, chg_limit, wpc_temp,
>>>>>>> upstream/android-13
