...
<<<<<<< HEAD
	g4 = (u32) (sqsum / 100000000);
	g3 = (u32) ((sqsum - g4 * 100000000) / 1000000);
	g2 = (u32) ((sqsum - g4 * 100000000 - g3 * 1000000) / 10000);
	g1 = (u32) ((sqsum - g4 * 100000000 - g3 * 1000000 - g2 * 10000) / 100);
	g0 = (u32) ((sqsum - g4 * 100000000 - g3 * 1000000 - g2 * 10000 - g1 * 100));
=======
	g4 = sqsum / 100000000;
