...
static const struct s3c2410_wdt_variant drv_data_s5e8535_v1 = {
	.noncpu_int_en = S5E8535_CLUSTER0_NONCPU_INT_EN,
	.mask_bit = 2,
	.rst_stat_reg = EXYNOS5_RST_STAT_REG_OFFSET,
	.rst_stat_bit = 24,	/* CLUSTER0 WDTRESET */
	.pmu_reset_func = s3c2410wdt_noncpu_int_en,
...
static const struct s3c2410_wdt_variant drv_data_s5e8535_v2 = {
	.noncpu_int_en = S5E8535_CLUSTER1_NONCPU_INT_EN,
	.mask_bit = 3,
	.rst_stat_reg = EXYNOS5_RST_STAT_REG_OFFSET,
...
=======
	...
	{ .compatible = "samsung,s5e8535-v1-wdt",
	  .data = &drv_data_s5e8535_v1 },
	{ .compatible = "samsung,s5e8535-v2-wdt",
	  .data = &drv_data_s5e8535_v2 },
>>>>>>> upstream/android-13
	{},
};
...
=======
	...
	if (!of_property_read_u32(dev->of_node, "shutdown_wdt_timeout",
		...
		dev_info(dev, "Shutdown Watchdog timeout value is: %d\n", wdt->shutdown_timeout);
	} else {
		wdt->shutdown_timeout = 30;
		dev_info(dev, "Shutdown timeout value is not defined. We set it for 30secs\n");
	}
