cmd_scripts/pnmtologo := clang -Wp,-MD,scripts/.pnmtologo.d -Iscripts -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89  -I../tools/include   -o scripts/pnmtologo ../scripts/pnmtologo.c   
