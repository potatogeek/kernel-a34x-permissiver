...
#define tSrcTransition			(35)	
#define tPSSourceOn				(440)	
#define tPSSourceOff			(760)	
#define tSenderResponse			(27)	
#define tSendSourceCap			(150)	
#define tPSHardReset			(25)	
#define tSinkWaitCap			(550)	
#define tPSTransition			(490)	
#define tVCONNSourceOff			(25)	
#define tVCONNSourceOn			(100)	
#define tVDMSenderResponse		(30)	
#define tVDMWaitModeEntry		(50)	
#define tVDMWaitModeExit		(50)    
#define tDiscoverIdentity		(50)	
#define tSwapSourceStart		(20)	
#define tSwapSinkReady			(15)	
#define tSrcRecover				(670)	
...
typedef union {
	...
	struct {
		unsigned max_current:10;	
		unsigned min_voltage:10;	
		unsigned max_voltage:10;	
		unsigned supply_type:2;
	} power_data_obj_variable;

	struct {
		unsigned max_power:10;		
		unsigned min_voltage:10;	
		unsigned max_voltage:10;	
		unsigned supply_type:2;
...
struct sm5714_usbpd_manager_data {
	sm5714_usbpd_manager_command_type cmd;  
