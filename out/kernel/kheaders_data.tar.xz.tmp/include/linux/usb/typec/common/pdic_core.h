...
enum {
	...
	PDIC_DOCK_UNSUPPORTED_AUDIO = 115,	
	PDIC_DOCK_NEW		= 200,  
};
...
#define DP_PIN_ASSIGNMENT_A	0x00000001	
#define DP_PIN_ASSIGNMENT_B	0x00000002	
#define DP_PIN_ASSIGNMENT_C	0x00000004	
#define DP_PIN_ASSIGNMENT_D	0x00000008	
#define DP_PIN_ASSIGNMENT_E	0x00000010	
#define DP_PIN_ASSIGNMENT_F	0x00000020	
