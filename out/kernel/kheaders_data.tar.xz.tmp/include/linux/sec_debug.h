...
enum sec_reset_reason {
	...
	SEC_RESET_REASON_FOTA_BL   = (SEC_RESET_REASON_PREFIX | 0x6), 
	SEC_RESET_REASON_SECURE    = (SEC_RESET_REASON_PREFIX | 0x7), 
	SEC_RESET_REASON_FWUP      = (SEC_RESET_REASON_PREFIX | 0x9), 
	SEC_RESET_REASON_IN_OFFSEQ = (SEC_RESET_REASON_PREFIX | 0xA),
	#if defined(CONFIG_SEC_ABC)
	SEC_RESET_REASON_USER_DRAM_TEST   = (SEC_RESET_REASON_PREFIX | 0xB), 
	#endif
	...
	SEC_RESET_CP_DBGMEM        = (SEC_RESET_SET_PREFIX | 0x50000), 

	#ifdef CONFIG_DIAG_MODE
	SEC_RESET_SET_DIAG         = (SEC_RESET_SET_PREFIX | 0xe)	
	#endif
